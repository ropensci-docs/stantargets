# Multiple MCMCs per model with tidy output

Internal function for replicated MCMC. Users should not invoke directly.
...
A list of target objects. Target objects represent skippable steps of
the analysis pipeline as described at
<https://books.ropensci.org/targets/>. Developers can consult the design
specification at <https://books.ropensci.org/targets-design/> to learn
about the structure and composition of target objects.
